...
# MILo's train.py / mesh_extract_*.py live in the inner package dir
# (/opt/milo/milo), not the repo root (/opt/milo). Verified in the milo sidecar
# image 2026-06-21 — the previous "/opt/milo" pointed one level too high and
# every invocation failed with "can't open file '/opt/milo/train.py'".
MILO_DIR = Path(os.environ.get("MILO_DIR", "/opt/milo/milo"))

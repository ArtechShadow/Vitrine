...
Usage::
    ...
    inpainter = ComfyUIInpainter(api_url="http://localhost:3001")
...
class ComfyUIInpainter:
    ...
    ----------
    api_url : str
        Base URL of the SaladTechnologies comfyui-api (e.g. ``http://localhost:3001``).
    comfyui_url : str
        Direct ComfyUI URL for object_info queries (e.g. ``http://localhost:8189``).
    local_ip : str
    ...
    def from_config(cls, cfg: Any) -> "ComfyUIInpainter":
        ...
        return cls(
            api_url=getattr(cfg, "comfyui_api_url", "http://localhost:3001"),
            comfyui_url=getattr(cfg, "comfyui_direct_url", "http://localhost:8189"),

...
- **comfyui** (default, highest quality): Uses RTDETR_detect for person
  ...
  the remote ComfyUI server at localhost:8188.
...
Usage::
    ...
    remover = PersonRemover(method="comfyui", comfyui_url="http://localhost:8188")
...
class PersonRemover:
    ...
    comfyui_url : str | None
        ComfyUI WebSocket/API URL (e.g. "http://localhost:8188").

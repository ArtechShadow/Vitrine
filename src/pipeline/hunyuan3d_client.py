...
Usage::
    ...
    client = Hunyuan3DClient(comfyui_url="http://localhost:8189")
...
class Hunyuan3DClient:
    ...
    def __init__(
        ...
        api_url: str | None = "http://localhost:3001",
        timeout: int = 600,
    ...
    def from_config(cls, cfg: Any) -> "Hunyuan3DClient":
        ...
        """
        return cls(
            comfyui_url=getattr(cfg, "comfyui_url", "http://localhost:8189"),
            api_url=getattr(cfg, "api_url", "http://localhost:3001"),

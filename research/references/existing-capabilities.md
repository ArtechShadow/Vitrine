...
## Consolidated Docker (localhost)

### Hardware
- 2x NVIDIA RTX 6000 Ada (96 GB total VRAM)
- AMD Threadripper PRO 48-core
- 251 GB RAM
- ~216 GB unified model tree on fast SSD (`data/comfyui/models`)
...
- ~216 GB unified model tree at `data/comfyui/models` (ComfyUI's native model store; mounted in-container at `/comfyui/models`)

...
| FR-31 | Docker-network model mesh (v2g-net) | Missing | `config.py:135-136` `comfyui_api_url = "http://localhost:3001"`; `config.py:152-153` `comfyui_url = "http://localhost:8189"`; `config.py:171` `local_ip = "192.168.2.1"`; `comfyui_inpainter.py:282-284` same literals; `hunyuan3d_client.py:192-193` same literals | Hardcoded IP literals throughout; no service-DNS names; no `v2g-net` Docker network |
...
| `comfyui_inpainter.py:282-284`, `config.py:135-136,152-153,171`, `hunyuan3d_client.py:192-193` | FR-31/FR-33 require service-DNS names; hardcoded `localhost` literals contradict this |

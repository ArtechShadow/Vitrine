...
| `v2g-net` Docker mesh (replacing hardcoded `localhost`) | ADR-013, ADR-014 | FR-31, FR-33, FR-34 | SEC-04 (11 hardcoded endpoints) |
...
| P2-1 | Replace hardcoded `localhost` with service-DNS / manifest endpoints | FR-31/33, SEC-04 | Med | qe-02, qe-04 |

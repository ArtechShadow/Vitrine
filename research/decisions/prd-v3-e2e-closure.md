...
- **FR-31** — **Docker-network model mesh (`v2g-net`).** Replace hardcoded `localhost:port` /
...
- **FR-33** — **Connect over `v2g-net`.** Replace hardcoded `localhost:{3001,8189,8188}` defaults
